...
function elements = Example_5_11(ra1, ra2, ra3, dec1, dec2, dec3, stime1, stime2, stime3, time12, time13)
...
t     = [0, time12,time13];
ra    = [ra1,ra2,ra3]*deg;
dec   = [dec1, dec2, dec3]*deg;
theta = [stime1, stime2, stime3]*deg;
%...
...
elements = [coe(2), coe(7), coe(4)/deg, coe(3)/deg, coe(5)/deg, coe(6)/deg];
