...
while (abs(ratio) > tol) & (n <= nmax)
    n     = n + 1;
    ratio = F(z,t, A, mu, r1, r2)/dFdz(z, r1, r2, A);
    z     = z - ratio;
end
...
function dum = dFdz(z, r1, r2, A)
    if z == 0
        ...
        dum = (y(z, r1, r2, A)/C(z))^1.5*(1/2/z*(C(z) - 3*S(z)/2/C(z)) ...
               + 3*S(z)^2/4/C(z)) + A/8*(3*S(z)/C(z)*sqrt(y(z, r1, r2, A)) ...
               + A*sqrt(C(z)/y(z, r1, r2, A)));
    end
endfunction
